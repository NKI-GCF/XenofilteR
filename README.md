...
which is in the default settings not generated by STAR, is mandatory to run with XenofilteR. 
Please add the following to your STAR command when mapping to teh human as well as the mouse reference genome:

--outSAMattributes NM

See also the [STAR manual] (https://github.com/alexdobin/STAR/blob/master/doc/STARmanual.pdf) (section 9.11)
...
## 
- [ ] Catch STAR mapped samples missing teh 'NM'-tag
